...
Uinf=3
rho=1.204
pathName='E://Research//Scripts//Potential Flow//Panel Method//Git_Panel_Methods//NACA_2411.txt'
...
title=r'NACA 2411, $   Kutta: C_L = $' + '{:.3f}'.format(Cl_kutta[0]) + r'   Bernoulli: $C_L = $' + '{:.3f}'.format(Cl_bern[0]) + \
...
plt.savefig('velocity_NACA_2411_AoA_5.png')
...
plt.title(title,fontsize=16)
plt.savefig('pressure_NACA_2411_AoA_5.png')
