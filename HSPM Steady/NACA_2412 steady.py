...
title=r'NACA 2412, $   Kutta: C_L = $' + '{:.3f}'.format(Cl_kutta[0]) + r'   Bernoulli: $C_L = $' + '{:.3f}'.format(Cl_bern[0]) + \
...
plt.savefig('velocity_NACA_2412_AoA_5.png')
...
plt.title(title,fontsize=16)
plt.savefig('pressure_NACA_2412_AoA_5.png')
